...
### Flashing a USB stick {#flashing-a-usb-stick}
...
### Set terminal font size and keyboard layout {#set-terminal-font-size-and-keyboard-layout}
...
### Create the btrfs main file system {#create-the-btrfs-main-file-system}
...
#### Preparing for the Arch installation environment {#preparing-for-the-arch-installation-environment}
...
### Bootstrapping a basic Linux system {#bootstrapping-a-basic-linux-system}
...
### Enter the chroot environment {#enter-the-chroot-environment}
...
### Mount the swap partition {#mount-the-swap-partition}
...
### Set zoneinfo and hostname {#set-zoneinfo-and-hostname}
...
### More packages to install {#more-packages-to-install}
...
### Install Cosmic desktop {#install-cosmic-desktop}
...
### Other services to start {#other-services-to-start}
...
### Update the pacman mirrorlist {#update-the-pacman-mirrorlist}
...
### Blacklist the b43 driver {#blacklist-the-b43-driver}
